            ...
            <div className="flex-1 space-y-6">
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground text-lg max-w-md leading-relaxed">
                  Your sales operations are currently{" "}
                  <span className="text-green-600 font-medium">
                    ahead of schedule
                  </span>
                  . Review your stats for{" "}
              ...
              <div className="flex items-center gap-4">
                <Link href="/admin/sales">
                  <Button className="h-14 px-8 cursor-pointer bg-primary hover:bg-primary/90 text-primary-foreground shadow-xl shadow-primary/20 rounded-2xl gap-3 text-lg font-bold transition-all hover:-translate-y-1">
            ...
            <div className="lg:w-80 w-full flex flex-col gap-3 justify-center">
              <div className="p-4 rounded-2xl bg-muted/30 border border-border/50">
                ...
                <div className="grid grid-cols-1 gap-2">
                  <Button
                    variant="ghost"
                    className="justify-start h-12 rounded-xl hover:bg-white dark:hover:bg-zinc-900 hover:shadow-sm border border-transparent hover:border-border transition-all gap-3 group"
                  >
